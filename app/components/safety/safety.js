...
function _uiUpdateFooterMapInfo(item) {
    ...
    $('#safety_footer_map_info_title').html(item.title_company);
    $('#safety_info_map_obj_info_1_text').html(item.text_company);
...
$(function () {
    ...
    var barometrValue = ($('#barometr') && $('#barometr').data('value'));
