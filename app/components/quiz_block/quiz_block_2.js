var polls_item = {
    ...
    items: [
        {
            id: 1,
            type: 'multi_switch_selector',
            title: 'Отметьте ниже локальные нормативные акты, с которыми Вы ознакомлены:',
            items: [{
                    id: 1,
                    txt: 'Комплаенс политика',
                    need_input: false, // поле ввода если выбрать этот пункт меню
                    placeholder: 'Введите количество дней' // demo
                },
                {
                    id: 2,
                    txt: 'Комплаенс программа. Порядок осуществления Комплаенс процедур'
                },
                {
                    id: 3,
                    txt: 'Кодекс корпоративной этики',
                },
                {
                    id: 4,
                    txt: 'Политика по противодействию коррупции'
                },
                {
                    id: 5,
                    txt: 'Комплаенс регламент в области лицензирования и природопользования'
                },
                {
                    id: 6,
                    txt: 'Комплаенс регламент в области валютного контроля'
                },
                {
                    id: 7,
                    txt: 'Комплаенс регламент в области земельных и имущественных отношений'
                }
            ]
        },
        {
            id: 2,
            type: 'single_switch_selector',
            title: 'Отметьте ниже мероприятия, в которых Вы принимали участие: ',
            items: [{
                    id: 1,
                    txt: 'Обучения/тренинги/семинары по Комплаенс',
                    need_input: false, // поле ввода если выбрать этот пункт меню
                    placeholder: 'Введите количество дней' // demo
                },
                {
                    id: 2,
                    txt: 'Онлайн-тестирование по Комплаенс'
                },
                {
                    id: 3,
                    txt: 'Процедура оценки комплаенс-угроз в Обществе',
                }
            ]
        },
        {
            id: 3,
            type: 'multi_rows',
            title: 'Подтвердите, что Вы ознакомлены с указанными ниже локальными нормативными актами: ',
            items: [{
                    id: 1,
                    type: 'single_radio_list_horizontal_flex', // вертикальный список radio
                    txt: '1. Комплаенс политика',
                    items: ['Да', 'Нет']
                },
                {
                    id: 2,
                    type: 'single_radio_list_horizontal_flex', // вертикальный список radio
                    txt: '2. Комплаенс программа. Порядок осуществления Комплаенс процедур',
                    items: ['Да', 'Нет']
                },
                {
                    id: 3,
                    type: 'single_radio_list_horizontal_flex', // вертикальный список radio
                    txt: '3. Кодекс корпоративной этики',
                    items: ['Да', 'Нет']
                },
                {
                    id: 4,
                    type: 'single_radio_list_horizontal_flex', // вертикальный список radio
                    txt: '4. Политика по противодействию коррупции',
                    items: ['Да', 'Нет']
                },
            ]
        },
