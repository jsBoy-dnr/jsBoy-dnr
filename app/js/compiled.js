...
$(function () {
    $(document).on('click', '.header-right .item .item-body .item.mobile > div.top span', function () {
        ...
        $(this).parents('.header-right .item').removeClass('opened');
    ...
    $('.header-right .item .item-title').on('click', function () {
        ...
        $('.header-right').toggleClass('open_popup');
        $(this).closest('.item').toggleClass('opened');
    });
    $('.header-right .close-modal').on('click', function () {
        $(this).closest('.item').find('.item-title').removeClass('active');
        $(this).closest('.item').find('.item-body').removeClass('opened');
    ...
    $(document).click(function (event) {
        ...
        $('.header-right .button1').removeClass('opened');
    });
    $(document).click(function (event) {
        ...
        $('.header-right .button2').removeClass('opened');
    });
    $(document).click(function (event) {
        ...
        $('.header-right .button3').removeClass('opened');
    });
...
$(function () {
    ...
    $('.ke_slider').addClass('owl-carousel');

    $('.ke_slider').owlCarousel({
        loop: false,
        margin: 0,
        items: 1,
        nav: false,
...
$(function () {
    $(".hnblock-in-desktop").addClass("owl-carousel").owlCarousel({
        loop: false,
        margin: 0,
        items: 1,
        nav: false,
...
$(function () {
    $(window).on('resize', function () {
        ...
        if (matchMedia('(max-width: 1024px)').matches) {
            ...
            $('.lk-pu_slider').addClass('owl-carousel');

            $('.lk-pu_slider').owlCarousel({
                loop: false,
                margin: 0,
                items: 1,
                nav: false,
        ...
        if (matchMedia('(min-width: 1025px)').matches) {
          ...
          $('.quiz-block .items-wrap, .event-block .items-wrap, .news_slider .items-wrap, .curator-desc .items-wrap, .important-info__cards').addClass('owl-carousel');
            ...
            $('.staff-block .items-wrap, .quiz-block .items-wrap, .event-block .items-wrap, .important-info__cards, .portovik .items__list, .sobiludi .items__list').removeClass('owl-carousel');
            $('.quiz-block .items-wrap, .staff-block .items-wrap, .event-block .items-wrap, .important-info__cards, .portovik .items__list, .sobiludi .items__list').owlCarousel('destroy');
        }
    }).trigger('resize');

    $('.kpe-slider .blocks__wrap').addClass('owl-carousel');

    $('.kpe-slider .blocks__wrap').owlCarousel({
        loop: true,
        margin: 0,
        items: 1,
        nav: false,
...
$(function () {
    var blockTabs = $('.my_tasks_block .block-data-tab');
...
$(function () {
    $('.sort_bl_title').on('click', function () {
        ...
        $(this).closest('.sort_bl').parent().toggleClass('open_filter');

        var blHeight = $('.sort_bl .sort_bl_body').height();
...
$(function () {
    var IS_IOS = /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream;
    if (1) {
        $('.block_popup_org .items-wrap').styler();
        $('.choose-button .ttit').on('click', function (e) {
            e.preventDefault();
            $('.block_popup_org .block_popup_org_in .items-wrap').trigger('click');
        });
    }
    ...
    if (1) {
        $('.choose-button').click(function () {
            $('.block_popup_org').addClass('opened');
            console.log('oko1');
            return false;
        });
        $('.block_popup_org .icon-close, .block_popup_org .reset').click(function () {
            $('.block_popup_org').removeClass('opened');
            $('#tcal').hide();
            return false;
        });
        $(document).click(function (event) {
            if ($(event.target).closest('.block_popup_org_in').length)
                return;
            $('.block_popup_org').removeClass('opened');
            event.stopPropagation();
        });
        ...
        $('.block_popup_org .block_popup_org_in .btns .reset').on('click', function () {
            $('.choose-button .ttit').text('Выбрать функциональную специализацию');
            $('.step_one_blocks .item').removeClass('active');
            $('.step_blocks .step_two').hide();
            $('.step_two_blocks li a').removeClass('active');
            $('.step_blocks .step_three').hide();
            $('.step_three_blocks li a').removeClass('active');
            $('.step_blocks .step_four').hide();
        });
        $('.block_popup_org .block_popup_org_in .btns .go-to').on('click', function (e) {
            e.preventDefault();
            $('.items-wrap p').each(function () {
                if ($(this).hasClass('selected')) {
                    var tText = $(this).text();
                    $('.choose-button .ttit').text(tText);
                    $('.step-two_m__title').text(tText);
                    $('.block_popup_org').removeClass('opened');
                }
            });
        });
        $('.step_blocks.division .step_one_blocks a').on('click', function (e) {
            e.preventDefault();
            $(this).each(function () {
                var tTextSub = $(this).text();
                $('.step-two_m__subtitle').text(tTextSub);
        ...
        $('.step-two_m__inner .step_one_blocks a').on('click', function (e) {
            e.preventDefault();
            $(this).each(function () {
                $('.step-two_m__struct .step_four').show();
            });
        });

        $('.step-two_m .btn-close').on('click', function (e) {
            $('.step-two_m').removeClass('open');
            $('html').css({
                'overflow': 'auto',
                'padding-right': '0'
            });
            $('.blocks-wrapper').css('zIndex', '2');
            $('.site-header').css('zIndex', '2');
...
$(function () {
    ...
    $('.staff-block .items-wrap .item .image .label, .mmtp .slider_middle .blocks .label').on('click', function () {
        var thName = $(this).closest('.blocks').find('.title').text();
        $('.birthday_popup_title span').text(thName);
        $('.birthday_popup').addClass('opened');
        return false;
    });
    ...
    $(this).on('click', '.step_four .label', function () {
        $(this).siblings('div').show();
        return false;
    }).on('click', 'ul.menu-top-divizion li.s3-menu-allin-has .label', function () {
